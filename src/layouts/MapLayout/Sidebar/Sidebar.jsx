  ...
  return (
    <>
      <div className="menu" onClick={toggleNavbar}>
        <FontAwesomeIcon color="#fff" fontSize={20} icon={faBars} />
      </div>
      <div className={clsx("sidebar", isSideBarOpen && "open")}>
        <div className="d-flex align-items-center ps-3 pt-2 p-relative">
